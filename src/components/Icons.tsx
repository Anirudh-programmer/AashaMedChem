...
export const FlaskIcon = ({ size = 20, ...props }: IconProps) => (
  <svg
  ...
  >
    ...
    <path d="M12 3v14" />
    <path d="M9 9h6" />
    <path d="M10 3v4.6a2 2 0 0 1-.58 1.4L4.35 14.1a3 3 0 0 0-.35 3.9C5 19.4 6.7 20 8.5 20h7c1.8 0 3.5-.6 4.5-2a3 3 0 0 0-.35-3.9l-5.07-5.1a2 2 0 0 1-.58-1.4V3" />
  </svg>
);
...
export const FileTextIcon = ({ size = 20, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
